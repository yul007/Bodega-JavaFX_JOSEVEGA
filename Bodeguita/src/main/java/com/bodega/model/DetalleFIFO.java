...
public class DetalleFIFO {
    ...
    public BigDecimal getCantidadDisponibleRestante() {
        return cantidadDisponibleRestante;
    }

    public void setCantidadDisponibleRestante(BigDecimal cantidadDisponibleRestante) {
        this.cantidadDisponibleRestante = cantidadDisponibleRestante;
    }
}
